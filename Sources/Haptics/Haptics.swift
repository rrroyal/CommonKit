...
public extension Haptics {
	...
	enum HapticStyle {
		...
		/// Sheet presentation style, `FeedbackStyle.soft`.
		public static let sheetPresentation: Self = .soft
		/// Button press style, `FeedbackStyle.light`.
		public static let buttonPress: Self = .light
	}
}
